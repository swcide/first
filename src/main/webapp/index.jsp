			...
			<div class="slider-inner" style="background-image: url('resources/images/landing/landing1.jpg');background-position: 50% 0;">
				...
				<div class="container">
					<div class="slider-caption slider-caption-center">
						<h2 data-animate="fadeInDown">Welcome to My site</h2>
						<div data-animate="fadeIn" class="text-center topmargin-sm">

							<a href="home.do" class="button button-3d button-purple button-rounded button-xlarge">visit</a>
